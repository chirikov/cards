...
var jscolor = {
	...
	dir : 'http://localhost/cards/images/', // location of jscolor directory (leave empty to autodetect)
	bindClass : 'colorPick', // class name
	...
	color : function(target, prop) {
		...
		this.pickerFaceColor = '#eee' //'ThreeDFace' // CSS color
		this.pickerBorder = 1 // px
		this.pickerBorderColor = '#d3d3d3' //'ThreeDHighlight ThreeDShadow ThreeDShadow ThreeDHighlight' // CSS color
		this.pickerInset = 1 // px
		this.pickerInsetColor = '#d3d3d3' //'ThreeDShadow ThreeDHighlight ThreeDHighlight ThreeDShadow' // CSS color
